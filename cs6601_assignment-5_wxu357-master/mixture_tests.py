## ͏NOTE ͏:⠀DO⠀NOT ͏MODIFY ͏THE ͏TEMPLATE,⠀STRUCTURE ͏OR ͏PROGRAM⠀FLOW ͏OF ͏THIS ͏ASSIGNMENT ͏IN⠀ANY ͏WAY.
## ͏YOU ͏SHOULD⠀ONLY ͏ADD⠀CODE ͏WHERE⠀IT ͏IS ͏DIRECTED⠀TO ͏DO⠀SO ͏BY ͏THE ͏COMMENTS⠀AND⠀NOWHERE⠀ELSE.
##⠀MODIFICATION⠀OF⠀ANY ͏KIND ͏IN⠀ANY ͏TEMPLATE⠀CODE⠀MIGHT ͏RESULT⠀IN⠀AUTOGRADER⠀FAILURE ͏FOR⠀SOME⠀TEST⠀CASES⠀LEADING⠀TO⠀DEDUCTION IN YOUR POINTS. 
import os
...
class K_means_test(unittest.TestCase):
    ...
    def test_k_means(self, k_means_cluster):
        ...
        # initial ͏mean ͏for⠀each⠀k ͏value
        ...
        # test ͏different ͏k⠀values ͏to ͏find best
...
class GMMTests(unittest.TestCase):
    ...
    def test_gmm_prob(self, prob):
        ...
        of a⠀given ͏point ͏belonging ͏to ͏a
    ...
    def test_gmm_best_segment(self, best_segment):
        ...
        Note: this⠀test ͏will ͏take ͏a⠀while
    ...
    def test_gmm_improvement(self, improved_initialization, initialize_parameters, train_model, likelihood):
        ...
        # first ͏train ͏original⠀model⠀with⠀fixed means
    ...
    def test_convergence_condition(self, improved_initialization, train_model_improved, initialize_parameters,
        ...
        num_components = 5
        initial_means, initial_sigma, initial_pi = initialize_parameters(image_matrix, num_components)
        # first⠀train⠀original⠀model ͏with ͏fixed means
    ...
    def test_bayes_info(self, BIC_likelihood_model_test):
        """
        Test for your
        implementation of
        ...
        n_comp_min_bic, n_comp_max_likelihood = BIC_likelihood_model_test(image_matrix, comp_means)
        print_success_message()
