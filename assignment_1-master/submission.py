...
class CustomEvalFn:
    ...
    def score(self, game, my_player=None):
        ...
        # TODO: finish this function!
        s = len(game.get_player_moves(my_player)) - 3 * len(game.get_opponent_moves(my_player))
...
class MyPlayer:
    ...
    def move(self, game, time_left):
        ...
        game_state_flat = [item for sublist in game_state for item in sublist]
        N = game_state_flat.count(' ')
        if N >=40: 
            d = 6
        else:
            d = 1
...
def org_alphabeta(player, game, time_left, depth, alpha=float("-inf"), beta=float("inf"), my_turn=True, moves_dict={}):
    """Implementation of the alphabeta algorithm.
    ...
    if my_turn:
        ...
        for m in moves:
            ...
            if is_over:
                ...
                _, v = org_alphabeta(player, new_game, time_left, depth - 1, alpha, beta, my_turn=False)
        ...
        for m in moves:
            ...
            if is_over:
                ...
                _, v = org_alphabeta(player, new_game, time_left, depth - 1, alpha, beta, my_turn=True)
...
class ComputerPlayer:
    ...
    def move(self, game, time_left):
        ...
        Returns:
            tuple: ((int,int),(int,int),(int,int)): Your best move
        """
        best_move, utility = org_alphabeta(self, game, time_left, depth=self.search_depth)
        return best_move
